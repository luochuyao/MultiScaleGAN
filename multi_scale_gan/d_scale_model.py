...
class DScaleModel:
    ...
    def __init__(self, scale_index, height, width, conv_layer_fms, kernel_sizes, fc_layer_sizes,is_w=False):
        """
            ...
            with tf.name_scope('convolutions'):
                ...
                for i in range(len(self.kernel_sizes)):
                    ...
                    last_out_height = conv_out_size(
                        last_out_height, self.c.PADDING_D, self.kernel_sizes[i], 1)
                    last_out_width = conv_out_size(
                        last_out_width, self.c.PADDING_D, self.kernel_sizes[i], 1)
            ...
            with tf.name_scope('calculation'):
                ...
                with tf.name_scope('convolutions'):
                    for i in range(len(conv_ws)):
                        ...
                        preds = tf.nn.conv2d(
                            last_input, conv_ws[i], [1, 1, 1, 1], padding=self.c.PADDING_D)
                ...
                with tf.name_scope('pooling'):
                    preds = tf.nn.max_pool(preds, [1, 2, 2, 1], [1, 2, 2, 1], padding=self.c.PADDING_D)

...
DATA_DIR = get_dir('/mnt/A/meteorological/')
# directory of unprocessed training frames
TRAIN_DIR = os.path.join(DATA_DIR, 'RadarData')
# directory of unprocessed test frames
TEST_DIR = os.path.join(DATA_DIR, 'AllRadarData')
...
STATS_FREQ      = 5000     # how often to print loss/train error stats, in # steps
SUMMARY_FREQ    = 5000    # how often to save the summaries, in # steps
IMG_SAVE_FREQ   = 5000   # how often to save generated images, in # steps
TEST_FREQ       = 20000   # how often to test the model on test data, in # steps
...
LRATE_G = 0.00001  # Value in paper is 0.0004
...
SCALE_FMS_G = [[HIST_LEN, 128, 256, 128, 1],
               [(HIST_LEN + 1), 128, 256, 128, 1],
               [(HIST_LEN + 1), 128, 256, 512, 256, 128, 1],
               [(HIST_LEN + 1), 128, 256, 512, 256, 128, 1]]
...
BALANCING_WEIGHTS = (1, 1, 2, 5, 15, 20)
##
# Discriminator model
##
